...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why? It grabs as many characters as it can lay its greedy hands on :-)

  # ------------------------------------------------------------------

  def test_the_left_most_match_wins
    assert_equal "a", "abbccc az"[/az*/]  # it stops after finding the first one...
  end
  ...
  def test_slash_w_is_a_shortcut_for_a_word_character_class
    ...
    assert_equal "variable_1", "variable_1 = 42"[/[a-zA-Z0-9_]+/]  # "42" is also considered a word, but only the first match is returned
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    assert_equal "start", "start end"[/\Astart/]  ## if the string appears at the beginning it returns the string
    assert_equal nil, "start end"[/\Aend/] ## because "end" des not appear at the beginning of the string 
  end
...
#       [/^.../] is DIFFERENT FROM [/[^a-z]/]
    assert_equal "2", "num 42\n2 lines"[/^\d+/]  # searches for pattern "new line + digits"
  end
