...
class AboutClasses < Neo::Koan
  ...
  class Dog5
    attr_accessor :name # = class Dog3: both read and write of @name
  end
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # 'new' calls 'initialize' and hence needs an argument. If I were to omit 
    # the 'def initialize' I wouldn't need to pass a value
