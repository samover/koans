...
class AboutScope < Neo::Koan
  ...
  #  puts fido.class  = AboutScope::Jims::Dog
  #  puts rover.class = AboutScope::Joes::Dog
  ...
  def test_bare_bones_class_names_assume_the_current_scope
    ...
    # the same on line 26, where AboutScope::Jims::Dog == ::Jims::Dog
  end

  def test_nested_string_is_not_the_same_as_the_system_string
    # Well no, because String is actually AboutScope::String while the "HI".class is String
